export default {
    meta: {
        title: "Jiasu Canvas",
        description: "Let an idea land on the canvas as an image.",
    },
    ...
    modelPlugin: {
        ...
        templates: { openai: "OpenAI format", gemini: "Gemini format", xinyun: "Jiasu protocol" },
        authoring: {
    ...
    auth: {
        brandMark: "JIASU",
        sloganLine1: "Let one image",
        sloganLine2: "land on the canvas.",
        loginEyebrow: "WELCOME BACK",
        loginTitle: "Enter the canvas",
        loginDescription: "Sign in to Jiasu Canvas with username or email.",
        registerEyebrow: "CREATE ACCOUNT",
        registerTitle: "Create your canvas account",
        registerDescription: "Sign in again after registration succeeds.",
        tabLogin: "Log in",
        ...
        registerUsernamePlaceholder: "Up to 20 characters",
        registerUsernameRequired: "Enter a username",
        usernameLength: "Username can be at most 20 characters",
        password: "Password",
        ...
        email: "Email",
        emailPlaceholder: "Used to receive a verification code",
        ...
        twoFactorDescription: "Enter the 6-digit code from your authenticator.",
        twoFactorAction: "Continue →",
        backToLogin: "Back to login",
        requestFailed: "Request failed. Try again later.",
        networkError: "Network error. Check your connection and try again.",
        forgotPassword: "Forgot password?",
        resetTitle: "Reset password",
        resetDescription: "We will email a reset link. Confirm it to generate a new password.",
        resetSendEmail: "Send reset email",
        resetEmailSent: "Reset email sent. Check your inbox for the link or token.",
        resetToken: "Reset token",
        resetTokenPlaceholder: "Token from the email link",
        resetTokenRequired: "Enter the reset token",
        resetConfirm: "Confirm reset",
        resetSuccess: "Password reset",
        resetNewPassword: "New password",
        resetCopyPassword: "Copy password",
        resetCopied: "New password copied",
        resetUseNewPassword: "Sign in with new password",
        resetBack: "Back",
        resetStep1: "Send email",
        resetStep2: "Confirm token",
        bootTitle: "Signed in. Starting the local workspace",
        bootPullConfig: "Loading account settings",
        bootSyncChannels: "Syncing channels",
        bootEnterWorkspace: "Opening workspace",
        bootStartingAgent: "Starting canvas service",
        splashTitle: "Preparing your workspace",
        splashSubtitle: "Starting up",
        splashStepEnv: "Checking runtime",
        splashStepSession: "Restoring session",
        splashStepAgent: "Starting canvas service",
        splashStepOpen: "Opening workspace",
        splashDone: "Done",
        splashNow: "In progress...",
        splashWait: "Waiting",
    },
    home: {
        promptError: "Failed to load prompts",
        description: "Generate, connect, and reshape <content>images, text, and graphics</content> in <canvas>Jiasu Canvas</canvas>, turning one-off generations into a continuous creative process.",
        start: "Get started",
    ...
    version: {
        ...
        desktopHotUpdate: "Desktop hot update",
        desktopInstallAndRestart: "Update and restart",
        desktopUpdateAvailable: "Update available: {{version}}",
        desktopUpToDate: "You are on the latest version",
        desktopPackagedOnly: "Hot updates are only available in packaged builds",
        desktopUnavailable: "Desktop hot update is not available here",
        desktopInstallFailed: "Failed to install the update",
        desktopRestarting: "Update ready — restarting…",
        hotUpdateMarker: "Hot-update test build {{version}}",
