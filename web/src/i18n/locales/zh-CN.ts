export default {
    ...
    modelPlugin: {
        ...
        templates: { openai: "OpenAI 规范", gemini: "Gemini 规范", xinyun: "佳速协议" },
        authoring: {
    ...
    auth: {
        ...
        loginTitle: "进入画布",
        loginDescription: "使用用户名或邮箱登录佳速画布。",
        registerEyebrow: "CREATE ACCOUNT",
        registerTitle: "创建你的画布账号",
        registerDescription: "注册成功后请再登录。",
        tabLogin: "登录",
        tabRegister: "注册",
        username: "用户名或邮箱",
        ...
        registerUsernamePlaceholder: "最长 20 个字符",
        registerUsernameRequired: "请输入用户名",
        usernameLength: "用户名最长 20 个字符",
        password: "密码",
        passwordPlaceholder: "请输入密码",
        passwordRequired: "请输入密码",
        passwordLength: "密码长度为 8 到 20 位",
        ...
        twoFactorTitle: "二次验证",
        twoFactorDescription: "请输入验证器中的 6 位验证码。",
        twoFactorAction: "继续 →",
        backToLogin: "返回登录",
        ...
        forgotPassword: "忘记密码？",
        resetTitle: "重置密码",
        resetDescription: "我们会向注册邮箱发送重置链接，确认后生成新密码。",
        resetSendEmail: "发送重置邮件",
        resetEmailSent: "重置邮件已发送，请查收邮箱中的链接或令牌",
        resetToken: "重置令牌",
        resetTokenPlaceholder: "邮件链接中的 token",
        resetTokenRequired: "请输入重置令牌",
        resetConfirm: "确认重置",
        resetSuccess: "密码已重置",
        resetNewPassword: "新密码",
        resetCopyPassword: "复制密码",
        resetCopied: "已复制新密码",
        resetUseNewPassword: "用新密码登录",
        resetBack: "返回",
        resetStep1: "发送邮件",
        resetStep2: "确认令牌",
        bootTitle: "登录成功，正在启动本地工作台",
        bootPullConfig: "拉取账号配置",
        bootSyncChannels: "同步渠道",
        bootEnterWorkspace: "进入工作台",
        bootStartingAgent: "启动画布服务",
        splashTitle: "正在准备你的工作台",
        splashSubtitle: "启动中",
        splashStepEnv: "检查运行环境",
        splashStepSession: "恢复登录会话",
        splashStepAgent: "启动画布服务",
        splashStepOpen: "打开工作台",
        splashDone: "完成",
        splashNow: "进行中...",
        splashWait: "等待中",
    },
    home: {
        promptError: "获取提示词失败",
        description: "在 <canvas>佳速画布</canvas> 中生成、连接和重组 <content>图片、文字与图形</content>，让创作从单次生成变成连续推演。",
        start: "开始使用",
        openCanvas: "打开画布",
    ...
    version: {
        ...
        desktopHotUpdate: "桌面热更新",
        desktopInstallAndRestart: "立即更新并重启",
        desktopUpdateAvailable: "发现新版本 {{version}}",
        desktopUpToDate: "已是最新版本",
        desktopPackagedOnly: "热更新仅在安装包/绿色版中可用",
        desktopUnavailable: "当前环境不支持桌面热更新",
        desktopInstallFailed: "更新安装失败",
        desktopRestarting: "更新已就绪，正在重启…",
        hotUpdateMarker: "热更测试包 {{version}}",
