        ...
        >
            <div className="grid gap-4 md:grid-cols-2">
                ...
                <label className="block md:col-span-2">
                    ...
                    <Input value={draft.baseUrl} onChange={(event) => patch({ baseUrl: event.target.value })} placeholder={defaultBaseUrlForApiFormat(draft.apiFormat)} />
                </label>
                <label className="block md:col-span-2">
