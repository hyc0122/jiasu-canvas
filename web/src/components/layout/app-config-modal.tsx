...
function resolveVisibleConfigTab(tab: ConfigTabKey): ConfigTabKey {
    if (tab === "local-proxy" || tab === "prompt-sources") return "channels";
    return tab;
}
...
export function AppConfigPanel({ showDoneButton = false, initialTab = "channels" }: { showDoneButton?: boolean; initialTab?: ConfigTabKey }) {
    ...
    const [activeTab, setActiveTab] = useState<ConfigTabKey>(() => resolveVisibleConfigTab(initialTab));
    ...
    useEffect(() => setActiveTab(resolveVisibleConfigTab(initialTab)), [initialTab]);
...
function apiFormatLabel(apiFormat: ApiCallFormat) {
    if (apiFormat === "xinyun") return "佳速协议";
